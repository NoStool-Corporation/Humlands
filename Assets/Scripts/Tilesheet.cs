...
public struct Tilesheet{
	...
	public static Vector2 SAND = new Vector2(13, 1);
	public static Vector2 SNOW = new Vector2(16, 1);
	public static Vector2 STONEBLOCK = new Vector2(19, 1);

	public static Vector2 tileSize = new Vector2(1/(7*3f), 1/3f);
}